...
Ces deux tableaux r̩pertorient tous les types de colonnes disponibles avec LaTeX et le package `array`. Quelques types de colonnes suppl̩mentaires, provenant d'autres paquets, sont pr̩sent̩s [en approfondissement](more-08) de cette le̤on.
